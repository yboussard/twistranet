...
from django_twistranet.twistranet.lib import permissions, roles, languages, slugify
from django_twistranet.twistranet.signals import request_add_to_network, accept_in_network
...
class UserAccount(Account):
    ...
    def save(self, *args, **kw):
        ...
        """
        from django_twistranet.twistranet.models import community
        if not self.slug:
    ...
    def getDefaultPublisher(self,):
        from django_twistranet.twistranet.models import GlobalCommunity
    ...
    def add_to_my_network(self):
        ...
        """
        from django_twistranet.twistranet.models.network import Network
