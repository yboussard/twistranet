...
from django_twistranet.twistranet.lib import roles, permissions
from django_twistranet.twistranet.lib.slugify import slugify
from django_twistranet.twistranet.signals import twistable_post_save
...
class Twistable(_AbstractTwistable):
    ...
    def kind(self) :
        ...
        """
        from django_twistranet.twistranet.models import Content, Account, Community, Resource
        mc = self.model_class
