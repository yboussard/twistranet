...
from django_twistranet.twistranet.lib.slugify import FULL_SLUG_REGEX
...
class PermissionField(models.CharField):
    ...
    def formfield(self, **kwargs):
        from django_twistranet.twistranet.forms import fields
        defaults = {
...
class ResourceField(models.ForeignKey):
    ...
    def upload_resource(self, instance, data):
        ...
        from django_twistranet.twistranet.models import Account, Resource, Content
    ...
    def save_form_data(self, instance, data):
        ...
        """
        from django_twistranet.twistranet.models import Resource
        resource = None
