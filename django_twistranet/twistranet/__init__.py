from django_twistranet import __author__, VERSION
__version__ = '.'.join(map(str, VERSION))

# Import / Load config & logger
from django_twistranet.config import defaults
...
from django_twistranet.twistranet.forms import community_forms, resource_forms
