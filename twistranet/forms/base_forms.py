...
from twistranet.forms.widgets import PermissionsWidget
...
class BaseForm(forms.ModelForm):
    def __init__(self, *args, **kw):
        ...
        """
        from twistranet.models.community import Community
        from twistranet.models.account import UserAccount
